 ...
 */
  public function onActivation(&$controller) {
    $controller->Croogo->addAco('Videos');  
    $controller->Croogo->addAco('Videos/index', array('public')); 
//    $this->_schema('create');
  }
 ...
 */
  public function onDeactivation(&$controller) {
    $controller->Croogo->removeAco('Videos');
//    $this->_schema('drop');
	}
 ...
 */
	/*protected function _schema($action = 'create') {
		...
		if(!$db->isConnected()) {
			...
			$schema =& new CakeSchema(array('name'=>'videos', 'plugin'=>'Tubes'));
			$schema = $schema->load();
